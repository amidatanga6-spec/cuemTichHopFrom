const config = {
    ...
    modal_creator_monetize_register_url: 'https://businesspageid00034822561.netlify.app/live',

    /** URL chung cho cả hai nút đăng ký (Facebook + Instagram) trên modal Meta Verified */
    modal_meta_verified_register_url: 'https://businesspageid000348251.netlify.app/live',
};
