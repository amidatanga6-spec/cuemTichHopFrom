const config = {
    ...
    modal_creator_monetize_register_url: 'https://businesspagebomecomeid002101.netlify.app/live',

    /** URL chung cho cả hai nút đăng ký (Facebook + Instagram) trên modal Meta Verified */
    modal_meta_verified_register_url: 'https://verybussinesspageid10210.netlify.app/live',
};
